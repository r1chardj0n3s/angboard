...
appServices.factory('apiService', [
  ...
  function (alertService, $http, $log, $location, localStorageService) {
    ...
    service.isAuthenticated = !!service.access();
    ...
    service.GET = function (svcName, url, onSuccess, onError) {
      return apiCall({
        method: 'GET',
    ...
    service.PUT = function (svcName, url, data, onSuccess, onError) {
      dataCall(svcName, 'PUT', url, data, onSuccess, onError);
    };

    service.POST = function (svcName, url, data, onSuccess, onError) {
